...
;Button Launch
$LPLaunchButton = _GUICtrlPic_Create(@WorkingDir & "\LP-Data\lostparadise-start.png", 642, 505, 144, 54)
...
GUICtrlCreateGroup("Additional Parameters", 258, 253, 264, 222)
GUICtrlSetFont(-1, 12, 400, 0, "Arial")
...
GUICtrlSetFont(-1, 12, 400, 0, "Arial")
$ShowScriptErrors = GUICtrlCreateCheckbox("Show script errors", 16, 52, 150, 20)
GUICtrlSetTip(-1, "Zeige Ingame Script Errors")
GUICtrlSetColor(-1, 0xcdd8e0)
$NoPause = GUICtrlCreateCheckbox("No Pause", 16, 75, 150, 20)
GUICtrlSetTip(-1, "Pausiert nicht das Game wenn im Hintergrund")
$NoPauseAudio = GUICtrlCreateCheckbox("No Pause Audio", 16, 98, 150, 20)
GUICtrlSetTip(-1, "Pausiert nicht das Game-Audio wenn im Hintergrund")
$WindowMode = GUICtrlCreateCheckbox("Window Mode", 16, 121, 150, 20)
GUICtrlSetTip(-1, "Zeigt das Game im Fenstermodus an")
$FilePatching = GUICtrlCreateCheckbox("File Patching", 16, 144, 150, 20)
GUICtrlSetTip(-1, "Erlaubt das Game ungepackte Files zu laden")
$CheckSignatures = GUICtrlCreateCheckbox("Check signatures", 16, 167, 150, 20)
GUICtrlSetTip(-1, "Überprüfe Signaturen von PBO Files")
$EnableBattlEye = GUICtrlCreateCheckbox("Enable BattlEye", 16, 190, 150, 20) ; Disabled da immer nötig
...
GUICtrlSetFont(-1, 12, 400, 0, "Arial")
$EnableHT = GUICtrlCreateCheckbox("Enable HT", 16, 276, 130, 20)
GUICtrlSetTip(-1, "Aktiviert Hyper-Threading")
$HugePages = GUICtrlCreateCheckbox("Huge pages", 16, 300, 130, 20)
$NoSplash = GUICtrlCreateCheckbox("No Splash Screen", 16, 325, 130, 20)
GUICtrlSetTip(-1, "Deaktiviert Default-Arma3 Splash Screens")
$NoLogs = GUICtrlCreateCheckbox("No logs", 16, 350, 130, 20)
...
$ExecutablePathSelect = GUICtrlCreateButton("Select", 446, 505, 70, 20)
GUICtrlSetBkColor(-1, 0x252729)
GUICtrlSetColor(-1, 0xcdd8e0)
GUICtrlCreateGroup("", -99, -99, 1, 1)
